      ...
      input: [
        {
          ...
          content: [
            ...
            { type: "text", text: `Seller price: ${sellerPrice ?? "unknown"}` },
            { type: "text", text: `Location: ${location || "unknown"}` },
            { type: "text", text: `Image text: ${imageText || "not provided"}` },
            ...(imageUrl
              ? [{ type: "image_url" as const, image_url: imageUrl, detail: "auto" as const }]
              : []),
          ],
        },
      ],
