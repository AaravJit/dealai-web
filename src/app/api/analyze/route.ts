...
type ResponsesInput = Array<{ role: "user"; content: ResponseContentItem[] }>;
...
function buildResponsesInput({
  ...
  const content: ResponseContentItem[] = [
    ...
    { type: "input_text", text: `Title: ${title}` },
    { type: "input_text", text: `Seller price: ${sellerPrice ?? "unknown"}` },
    { type: "input_text", text: `Location: ${location || "unknown"}` },
    { type: "input_text", text: `Image text: ${imageText || "not provided"}` },
  ];
