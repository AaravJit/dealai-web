    ...
    async function run() {
      ...
      try {
        ...
        const analysis = {
          ...
          confidence: (typeof data.confidence === "string" ? data.confidence : undefined) ?? "medium",
          condition: (typeof data.condition === "string" ? data.condition : undefined) ?? "good",
        ...
        const safeTitle = typeof data.title === "string" ? data.title : title ?? "Untitled listing";
        const safeLocation = typeof data.location === "string" ? data.location : loc ?? "Unknown";
        ...
        const docForState: DealDocument & { imageDataUrl?: string } = { ...doc, id, imageDataUrl: img };
